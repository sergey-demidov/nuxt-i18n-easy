...
(async () => {
      if (nuxtConfig.i18n instanceof Object) {
        if (Array.isArray(nuxtConfig.i18n.locales) && nuxtConfig.i18n.locales.length > 0) {
          config.locales = nuxtConfig.i18n.locales.slice()
        }
        if (typeof nuxtConfig.i18n.langDir === 'string') {
          config.langDir = nuxtConfig.i18n.langDir
        }
      }
      ...
      if (nuxtConfig.i18nTranslate instanceof Object) {
        if (Array.isArray(nuxtConfig.i18nTranslate.directories) && nuxtConfig.i18nTranslate.directories.length > 0) {
          config.directories = nuxtConfig.i18nTranslate.directories
        }
        if (Array.isArray(nuxtConfig.i18nTranslate.files) && nuxtConfig.i18nTranslate.files.length > 0) {
          config.fileMask = nuxtConfig.i18nTranslate.files
        }
        if (typeof nuxtConfig.i18nTranslate.sourceLanguage === 'string') {
          config.sourceLanguage = nuxtConfig.i18nTranslate.sourceLanguage
        }
      }
      const phrases = []
